...
import { MantineProvider, ColorSchemeProvider, ColorScheme, Modal, Group, Button } from '@mantine/core';
...
function App() {
  ...
  const [colourScheme, setColourScheme] = useState<ColorScheme>(preferredColorScheme);
